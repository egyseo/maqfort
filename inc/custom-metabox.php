...
/*
* -----------------------------------------------------------
* 9.0 Creat metabox for service page template.
* -----------------------------------------------------------
*/
if ( ! function_exists('maqfort_service_template') ) {

  function maqfort_service_template() {

  	$prefix = '_maqfort_service_template_';
  ...
  add_action( 'cmb2_init', 'maqfort_service_template' );
