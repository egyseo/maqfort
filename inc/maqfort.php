...
/*----------- Remove base category/taxonomie from the url -----------*/
/*add_filter('request', 'mf_change_term_request', 1, 1 );

function mf_change_term_request($query){

	$tax_name = 'categorias_de_produtos'; // specify you taxonomy name here, it can be also 'category' or 'post_tag'
...
function rudr_term_permalink( $url, $term, $taxonomy ){
	...
	$taxonomy_name = 'categorias_de_produtos'; // your taxonomy name here
	$taxonomy_slug = 'categorias_de_produtos'; // the taxonomy slug can be different with the taxonomy name (like 'post_tag' and 'tag' )
