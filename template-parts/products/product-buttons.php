...
<div style="display: none;" id="modal">
	<div class="buttons-wrapper">
		...
		if ( ! empty( $catalogo_geral ) ) :
			echo '<div class="button-content"><i class="fa fa-file-pdf-o" aria-hidden="true"></i><p>' , __( 'Catalogo Geral', 'maqfort' ) , '</p><a href="' , esc_url( $catalogo_geral ) , '" class="btn btn-primary btn-download" target="_blank">' , __( 'Download', 'maqfort' ) , '<i class="fa fa-download" aria-hidden="true"></i></a></div>';
		endif;
		if ( ! empty( $catalogo_individual ) ) :
			echo '<div class="button-content"><i class="fa fa-file-pdf-o" aria-hidden="true"></i><p>' , __( 'Catalogo Individual', 'maqfort' ) , '</p><a href="' , esc_url( $catalogo_individual ) , '" class="btn btn-primary btn-download" target="_blank">' , __( 'Download', 'maqfort' ) , '<i class="fa fa-download" aria-hidden="true"></i></a></div>';
		endif;
		if ( ! empty( $tabelas ) ) :
